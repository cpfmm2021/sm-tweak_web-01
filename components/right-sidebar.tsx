...
const periods = ['최근 7일', '최근 한 달', '최근 3개월']
...
export default function RightSidebar() {
  ...
  return (
    <aside className="w-80 h-screen bg-background border-l p-4 flex flex-col space-y-4">
      ...
      <Card className="bg-gradient-to-r from-purple-500 to-indigo-600 text-white">
        ...
        <CardContent>
          ...
          <Button variant="secondary" className="mt-4 w-full bg-white text-purple-700 hover:bg-purple-100">
            요금제 구독하기
          </Button>
        </CardContent>
      </Card>
